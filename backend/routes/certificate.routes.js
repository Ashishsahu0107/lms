...
router.get("/", authorize("super_admin", "teacher"), getAllCertificatesController);

// POST /api/certificates/issue -> Issue a certificate
router.post("/issue", authorize("super_admin", "teacher"), issueCertificateController);
...
router.get("/course/:courseId", authorize("super_admin", "teacher"), getCourseCertificatesController);

// GET /api/certificates/course/:courseId/students -> Retrieve enrolled students for course
router.get("/course/:courseId/students", authorize("super_admin", "teacher"), getCourseStudentsController);
