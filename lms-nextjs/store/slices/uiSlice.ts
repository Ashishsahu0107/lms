...
interface UIState { sidebarOpen: boolean; activeModal: string | null; isPageLoading: boolean; }
const slice = createSlice({
  name: "ui",
  initialState: { sidebarOpen: true, activeModal: null, isPageLoading: false } as UIState,
  reducers: {
...
export const { toggleSidebar, setSidebarOpen, setActiveModal, setPageLoading } = slice.actions;
