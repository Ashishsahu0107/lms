      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            role: { type: "string", enum: ["student", "teacher", "super_admin"] },
            avatar: { type: "string" },
            bio: { type: "string" },
            phone: { type: "string" },
        ...
        LoginRequest: {
          ...
          properties: {
            email: { type: "string", format: "email", example: "admin@lmspro.edu" },
        ...
        Quiz: {
          ...
          properties: {
            ...
            quizType: { type: "string", enum: ["practice", "exam", "homework"] },
        ...
        Assignment: {
          ...
          properties: {
            ...
            totalMarks: { type: "integer" },
            assignmentType: { type: "string", enum: ["written", "mcq", "code", "document"] },
            status: { type: "string", enum: ["draft", "published", "closed"] },
          },
        },
        // ── Message
        Message: {
          ...
          properties: {
            ...
            content: { type: "string" },
            messageType: { type: "string", enum: ["text", "image", "video", "audio", "file", "system"] },
            read: { type: "boolean" },
            createdAt: { type: "string", format: "date-time" },
          },
        },
        ...
        Certificate: {
          ...
          properties: {
            ...
            status: { type: "string", enum: ["Issued", "Pending", "Approved", "Rejected"] },
