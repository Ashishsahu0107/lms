  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "gold-glow":
          "0 0 20px rgba(201,162,39,0.4), 0 0 60px rgba(201,162,39,0.1)",
        "gold-sm":
          "0 0 10px rgba(201,162,39,0.3), 0 4px 15px rgba(201,162,39,0.1)",
        "gold-lg":
          "0 0 30px rgba(201,162,39,0.5), 0 0 80px rgba(201,162,39,0.2)",
        "luxury-card":
          "0 25px 50px -12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(201,162,39,0.08)",
      ...
      backgroundImage: {
        ...
        shimmer:
          "linear-gradient(90deg, rgba(201,162,39,0) 0%, rgba(201,162,39,0.12) 50%, rgba(201,162,39,0) 100%)",
      },
