    ...
    >
      ...
      <div className="border-b border-base-300 px-6 py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-base-content/60">FlyonUI Dashboard</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5">
        ...
        <div className="mt-8 rounded-3xl bg-gradient-to-br from-primary to-secondary p-5 text-primary-content shadow-xl">
          <div className="badge badge-neutral mb-3 border-none">PRO</div>

          <h3 className="text-lg font-bold">Upgrade Dashboard</h3>
      ...
      <div className="border-t border-base-300 p-4">
        <div className="flex items-center gap-3 rounded-2xl bg-base-200 p-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-base-content">Admin User</p>
