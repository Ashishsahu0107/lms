...
export const routesConfig = [
  ...
  {
    path: ROUTES.STUDENT_ATTENDANCE_CALENDAR,
  ...
  {
    path: ROUTES.TEACHER_PROGRESS,
    name: "Student Progress",
    roles: ["teacher"],
  },
  { path: ROUTES.TEACHER_ATTENDANCE, name: "Attendance", roles: ["teacher"] },
  {
    path: ROUTES.TEACHER_ATTENDANCE_HISTORY,
    name: "Attendance History",
    roles: ["teacher"],
  },
  {
    path: ROUTES.TEACHER_ATTENDANCE_REPORT,
  ...
  {
    path: ROUTES.TEACHER_CERTIFICATES,
    name: "Certificates",
    roles: ["teacher"],
  },
