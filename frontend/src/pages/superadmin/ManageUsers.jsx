...
export default function ManageUsers() {
  ...
  const roleOptions = useMemo(() => ['superAdmin', 'teacher', 'user'], []);
    ...
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Search, update roles, and block/unblock users.
        </p>
      </div>
        ...
        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900/40 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">
              Tip: Block/unblock affects authorization checks.
            </div>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-[900px] w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {users.map((u) => {
                const effectiveRole = form.roleById[u._id] ?? u.role;
                const effectiveBlocked =
                  form.blockedById[u._id] ?? u.isBlocked ?? false;
                    ...
                    <td className="px-4 py-3">
                      <select
                        ...
                        onChange={(e) =>
                          setForm((p) => ({
                            ...p,
                            roleById: { ...p.roleById, [u._id]: e.target.value },
                          }))
                        }
                      >
                        {roleOptions.map((r) => (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          disabled={loading}
                          onClick={() => applyRole(u._id, effectiveRole)}
                        >
                          Save Role
                        </button>
                        ...
                        <button
                          ...
                          disabled={loading}
                          onClick={() => applyBlock(u._id, !effectiveBlocked)}
                        >
                        ...
                        <button
                          type="button"
                          className="px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800 dark:text-gray-100 border border-gray-200 dark:border-gray-700 font-semibold"
                          disabled
                          title="Delete is not exposed in LMS admin UI"
                        >
                          Delete
                        </button>
                      </div>
