...
export default function StudentDetails({ data = {}, onBack, onSendEmail }) {
  const {
    student = {},
    enrollments = [],
    attempts = [],
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1 p-6 flex flex-col items-center justify-between space-y-6 bg-gradient-to-b from-card to-muted/20 border hover:shadow-md transition-all">
          ...
          {student.bio && (
            <div className="w-full text-sm text-muted-foreground p-3 border rounded-xl bg-card">
              <p className="text-xs font-semibold uppercase text-muted-foreground/80 tracking-wider mb-1">
                Student Bio
              </p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="hover:shadow-md transition-all">
            <CardHeader className="pb-2 border-b">
              <CardTitle className="text-base font-semibold flex items-center gap-2">
                <BookOpen className="h-5 w-5 text-blue-600" /> Syllabus Course
          ...
          <Card className="hover:shadow-md transition-all">
            <CardHeader className="pb-2 border-b">
              <CardTitle className="text-base font-semibold flex items-center gap-2">
                <Trophy className="h-5 w-5 text-amber-500" /> Quiz Performance
                Attempts Log
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
                      ...
                      {attempts.map((attempt) => (
                        ...
                        >
                          <td className="py-3 px-4 font-semibold text-foreground truncate max-w-xs">
                            {attempt.quizId?.title || "Class Quiz"}
                          </td>
