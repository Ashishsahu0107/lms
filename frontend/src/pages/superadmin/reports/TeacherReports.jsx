  ...
  return (
    <div className="space-y-6" id="teacher-reports-root">
      <div className="flex items-center justify-between">
        ...
        <h2 className="text-lg font-bold text-foreground">Teacher Telemetry Parameters</h2>
      </div>
      ...
      <Card className="p-6 space-y-4 max-w-2xl mx-auto hover:shadow-md transition-all">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-base">Teacher Syllabus Deployments & Engagement</h3>
            <p className="text-xs text-muted-foreground">Detailed auditing of educator lessons metrics.</p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-muted-foreground">
          This report exports a complete CSV sheet of all active teachers, mapping their academic specializations, taught courses counts, and accumulated student enrollments.
        </p>
        <div className="pt-4 border-t border-border flex justify-end">
          <a href={REPORTS_TEACHERS_URL} target="_blank" rel="noopener noreferrer">
