...
export default function CourseReports({ onBack }) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-base">
              Course Catalogs & Difficulty Analytics
            </h3>
            <p className="text-xs text-muted-foreground">
              Comprehensive academic audits of modules, lessons, and content
              revenue.
            </p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-muted-foreground">
          This report exports a complete CSV ledger listing all courses, their
          creators/instructors, categorizations, difficulty rankings, total
          active enrollments, and total revenue earned per course.
        </p>
        <div className="pt-4 border-t border-border flex justify-end">
          <a
            href={REPORTS_COURSES_URL}
            target="_blank"
