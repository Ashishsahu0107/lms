  ...
  return (
    <div className="space-y-6" id="revenue-reports-root">
      <div className="flex items-center justify-between">
        ...
        <h2 className="text-lg font-bold text-foreground">Revenue & Financial Telemetry</h2>
      </div>
      ...
      <Card className="p-6 space-y-4 max-w-2xl mx-auto hover:shadow-md transition-all">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-base">Financial Billing & Transaction Logs</h3>
            <p className="text-xs text-muted-foreground">Comprehensive platform-wide financial accounting audits.</p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-muted-foreground">
          This report exports a detailed CSV sheet mapping all transactions, invoice payments, subscription billing cycles, calculated teacher commissions, and accumulated platform net earnings.
        </p>
        <div className="pt-4 border-t border-border flex justify-end">
          <a href={REPORTS_REVENUE_URL} target="_blank" rel="noopener noreferrer">
