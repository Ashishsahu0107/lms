...
export default function StudentReports({ onBack }) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-base">
              Student Progress & Quiz Accuracy Telemetry
            </h3>
            <p className="text-xs text-muted-foreground">
              Detailed auditing of student learning metrics.
            </p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-muted-foreground">
          This report exports a complete CSV sheet of all registered students,
          mapping their enrolled course counts, actual finished courses, and
          calculated quiz score average percentages.
        </p>
        <div className="pt-4 border-t border-border flex justify-end">
          <a
            href={REPORTS_STUDENTS_URL}
            target="_blank"
