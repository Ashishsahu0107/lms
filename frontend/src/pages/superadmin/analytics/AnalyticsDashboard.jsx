...
import { Users, BookOpen, DollarSign, Target, Activity } from "lucide-react";
import {
  Card,
  CardContent,
  CardHeader,
...
export default function AnalyticsDashboard({ data, onNavigateToView }) {
  ...
  const categories = [
    {
      ...
      icon: Users,
      desc: "Audit active students, teachers, and growth metrics.",
      color: "blue",
    },
    {
      id: "courses",
      ...
      icon: BookOpen,
      desc: "Detailed breakdown of syllabus creation & pricing.",
      color: "indigo",
    },
    {
      id: "quizzes",
      label: "Quiz & Grades",
      icon: Target,
      desc: "Evaluate student score distributions and quiz completions.",
      color: "purple",
    },
    {
      id: "engagement",
      ...
      icon: Activity,
      desc: "Track average active hours, retention, and completions.",
      color: "rose",
    },
  ];
      ...
      >
        {[
          ...
          },
          {
            ...
            value: `$${(data?.revenueTotal || 128450).toLocaleString()}`,
            change: "+18.2%",
            icon: DollarSign,
            color: "emerald",
          },
      ...
      >
        {categories.map((cat) => {
          ...
          return (
            <Card
              key={cat.id}
              className="p-5 flex flex-col justify-between hover:shadow-lg hover:border-blue-500/20 border transition-all h-full bg-card"
            >
              <div className="space-y-3">
                <div
                  className={`p-2.5 w-fit rounded-lg bg-${cat.color}-500/10 text-${cat.color}-500`}
                >
