...
export default function EngagementAnalytics({ onBack, data }) {
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-base font-bold text-foreground">
              Weekly Average Learning Hours & Active Students
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-72">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Average daily student learning session
                </p>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">
            Acquisition Cohort Activity Metrics
          </CardTitle>
        </CardHeader>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border">
                {[
                  {
                    cohort: "Q1 2026 Cohort",
                    lessons: "24.5 lessons",
                    session: "2.8 hrs/day",
                    retention: "94.8%",
                  },
                  {
                    cohort: "Q4 2025 Cohort",
                    lessons: "42.0 lessons",
                    session: "2.5 hrs/day",
                    retention: "91.2%",
                  },
                  {
                    cohort: "Q3 2025 Cohort",
                    lessons: "68.2 lessons",
                    session: "2.1 hrs/day",
                    retention: "88.6%",
                  },
                ].map((row, idx) => (
