...
export default function QuizAnalytics({ onBack, data }) {
  const quizScores = [
    { range: "0-50%", count: 18 },
  ...
  const topQuizzes = [
    {
      title: "JavaScript Intermediate Scope",
    ...
    {
      title: "Visual Hierarchies & Layouts",
    ...
    {
      title: "Linear Regressions Analysis",
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-base font-bold text-foreground">
              Quiz Scores Range Spread (Total attempts)
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-72">
