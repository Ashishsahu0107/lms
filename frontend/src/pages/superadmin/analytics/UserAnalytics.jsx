...
export default function UserAnalytics({ onBack, data }) {
  const defaultGrowth = [
                ...
                {[
                  ...
                  <tr key={idx} className="hover:bg-muted/10">
                    ...
                    <td className="px-4 py-3 text-sm text-muted-foreground">
                      <Badge variant="secondary">+{row.s} new</Badge>
                    </td>
                    <td className="px-4 py-3 text-sm text-muted-foreground">
                      <Badge variant="outline">+{row.t} educators</Badge>
                    </td>
