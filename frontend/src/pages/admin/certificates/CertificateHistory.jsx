...
export default function CertificateHistory() {
  ...
  const handleRevoke = async (id) => {
    if (
      !window.confirm(
        "Are you sure you want to revoke/delete this certificate? This action is permanent!",
      )
    ) {
      return;
    }
  ...
  return (
    <div
      ...
      id="admin-certificate-history-page"
    >
      {/* Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Audit log of all student credentials and issue details
            </p>
          </div>
        </div>
                ...
                filteredCerts.map((record) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4 text-xs text-muted-foreground">
                      ...
                      {record.issuedBy?.role?.replace("_", " ")})
                    </td>
                    <td className="px-5 py-4 text-xs text-muted-foreground">
                    ...
                    <td className="px-5 py-4 flex gap-2">
                      ...
                      <Button
                        size="xs"
                        variant="outline"
                        className="text-[10px] text-red-500 border-red-200 hover:bg-red-50"
