...
const Dashboard = () => {
  ...
  const getWeatherIcon = () => {
    const hour = new Date().getHours();
    if (hour < 6 || hour > 18) return <Moon className="w-6 h-6 text-indigo-400" />;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
            ...
            <p className="text-4xl font-bold mb-1">{academicScore.overall}%</p>
            <p className="text-sm opacity-90 mb-4">Academic Score</p>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
            ...
            <p className="text-4xl font-bold mb-1">{assignmentSummary.completed}</p>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white shadow-lg">
            ...
            <p className="text-4xl font-bold mb-1">{learningStreak.current}</p>
            <p className="text-sm opacity-90 mb-4">Day Streak 🔥</p>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
            ...
            <p className="text-4xl font-bold mb-1">{skills.acquired}</p>
            <p className="text-sm opacity-90 mb-2">Skills Acquired</p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                {events.map((event) => (
                  <div 
                    key={event.id} 
                    className={`flex items-center gap-4 p-3 bg-gray-50 rounded-lg hover:shadow-md transition ${getPriorityColor(event.priority)}`}
                  >
                ...
                <div className="space-y-3">
                  {enrolledCourses.slice(0, 3).map(course => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-blue-600">Progress: {course.progress || 0}%</p>
                      </div>
                    </div>
                  ))}
                </div>
