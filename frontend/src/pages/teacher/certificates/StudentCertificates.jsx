...
import { ArrowLeft, Award, Calendar, Download, Search, RefreshCw, FileText, Plus, Shield } from "lucide-react";
    ...
    <div className="space-y-6 max-w-6xl mx-auto" id="teacher-certificates-page">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-border pb-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Registry of completion credentials issued for your courses</p>
        </div>
        <div className="flex gap-2">
          <Link to="/teacher/certificates/issue">
            <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold gap-1.5 text-xs">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                {["Certificate ID", "Student Name", "Course Title", "Issued On", "Actions"].map((h) => (
