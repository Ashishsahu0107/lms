...
import {
  Calendar, CheckCircle, XCircle, Clock, Plane, Filter, RefreshCw, FileText
} from "lucide-react";
    ...
    <div className="space-y-6 max-w-6xl mx-auto" id="attendance-history-page">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-border pb-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Detailed history of all marked class attendances</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={handleExport} disabled={loading} className="gap-2 text-sm">
      ...
      <Card className="border-border shadow-sm">
        <CardContent className="p-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
            ...
            <Button onClick={loadData} disabled={loading} className="bg-indigo-600 hover:bg-indigo-700 text-white h-10">
