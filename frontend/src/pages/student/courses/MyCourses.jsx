    ...
    return {
      ...
      lessons:
        course.modules?.reduce(
          (acc, mod) => acc + (mod.topics?.length || 0),
          0,
        ) || 0,
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center border border-base-300 bg-base-100/50">
          ...
          <p className="text-muted-foreground max-w-sm mx-auto mb-6">
            ...
            administrator or teacher to assign you access.
          </p>
        </Card>
      ) : (
  ...
  const content = (
    <>
      <div className="relative h-44 overflow-hidden bg-base-300">
        ...
        {course.progress > 0 && (
          <Badge className="absolute top-3 right-3 bg-primary text-primary-content border-0">
            {course.progress}% Complete
          </Badge>
        )}
        {course.certificate && (
          <Badge className="absolute top-3 right-3 bg-success text-success-content border-0">
            Completed
          </Badge>
        )}
      </div>
