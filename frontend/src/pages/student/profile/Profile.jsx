...
const profile = {
  ...
  achievements: [
    {
      title: "Quick Learner",
      desc: "Completed 5 courses in first month",
      icon: Award,
    },
    {
      title: "Perfect Score",
...
export default function Profile() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={item}
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-8"
      >
        <div className="relative z-10 flex flex-col md:flex-row gap-6 items-start">
          <div className="relative">
            <Avatar
              className="w-28 h-28 text-3xl bg-white/20"
              src={profile.avatar}
                ...
                {profile.achievements.map((ach, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <div className="p-2 rounded-lg bg-amber-100 shrink-0">
                      <ach.icon className="h-4 w-4 text-amber-600" />
                    </div>
                    <div>
